...
//          filters: myFilters,
          ...
          listeners: {
              load: function(myStore, myData, success) {
                  ...
                  myStore.each(me._inspectUserStories);
...
//          filters: myFilters,
          ...
          fetch: ['FormattedID', 'Name', 'Description', 'c_MoSCow', 'Release', 'Parent']   // Look in the WSAPI docs online to see all fields available!
        });
